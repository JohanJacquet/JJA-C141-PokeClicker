...
const magasin = reactive([
  ...
  {
    nom: "Zigzaton",
    img: "../assets/shopIcon/zigzaton.png",
    ...
    upgrades: [
      {
        ...
        acheterUpgrade: false,
        imgUpgrade: "../assets/shopIcon/zigzaton-upgrade.png",
        altUpgrade: "Amélioration Baie Oran de Zigzaton",
        tooltipUpgrade: "Augmente le DPS de Zigzaton de 100%.",
        erreur: false,
      },
      {
        nbreAchatRequis: 25,
        ...
        acheterUpgrade: false,
        imgUpgrade: "../assets/shopIcon/zigzaton-upgrade.png",
        altUpgrade: "Amélioration Baie Sitrus de Zigzaton",
        tooltipUpgrade: "Augmente le DPS de Zigzaton de 100%.",
        erreur: false,
      },
      {
        ...
        acheterUpgrade: false,
        imgUpgrade: "../assets/shopIcon/zigzaton-upgrade.png",
        altUpgrade: "Amélioration Vitesse Éclair de Zigzaton",
        tooltipUpgrade: "Augmente le DPS de Zigzaton de 100%.",
        erreur: false,
      },
      {
        ...
        acheterUpgrade: false,
        imgUpgrade: "../assets/shopIcon/zigzaton-upgrade.png",
        altUpgrade: "Amélioration Sprint de Zigzaton",
        tooltipUpgrade: "Augmente le DPS de Zigzaton de 125%.",
        erreur: false,
      },
      {
        nbreAchatRequis: 100,
        ...
        acheterUpgrade: false,
        imgUpgrade: "../assets/shopIcon/zigzaton-upgrade.png",
        altUpgrade: "Amélioration Flair de Zigzaton",
        tooltipUpgrade: "Augmente les DPC de 0.5% du DPS total.",
        erreur: false,
      },
      {
        nbreAchatRequis: 125,
        prixUpgrade: 10000000,
        multUpgrade: 1.5,
        pourcDpsEnDpc: 0,
        pourcDpcEnDps: 0,
        pourcAllDpsBoost: 0,
        ...
        acheterUpgrade: false,
        imgUpgrade: "../assets/shopIcon/zigzaton-upgrade.png",
        altUpgrade: "Amélioration Turbo de Zigzaton",
        tooltipUpgrade: "Augmente le DPS de Zigzaton de 150%.",
        erreur: false,
      }
    ],
    typeDegat: "DPS",
